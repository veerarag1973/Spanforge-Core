...
- 2.4  Tool span schema additions (arguments_raw, result_raw, retry_count,
       external_api) + SpanForgeConfig.include_raw_tool_io
...
class TestSpanEventDataclass:
    ...
    def test_exported_from_spanforge_namespace(self):
        from spanforge import SpanEvent as PublicSpanEvent
...
# ===========================================================================
# 2.4  SpanForgeConfig.include_raw_tool_io
# ===========================================================================
...
class TestPhase2Integration:
    ...
    def test_span_event_category_in_spanforge_init(self):
        """SpanEvent and SpanErrorCategory are accessible from top-level spanforge."""
        assert hasattr(spanforge, "SpanEvent")
        assert hasattr(spanforge, "SpanErrorCategory")
