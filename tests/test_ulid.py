"""Tests for spanforge.ulid — 100% coverage target.
...
class TestMonotonicity:
    def test_same_ms_monotonic(self) -> None:
        ...
        with patch("spanforge.ulid._now_ms", return_value=fixed_ms):
    ...
    def test_same_ms_overflow_spins_until_clock_advances(self) -> None:
        ...
        with patch("spanforge.ulid._now_ms", side_effect=advancing_clock):
            ulid = gen.generate()
