# RFC-0001: SPANFORGE — Open Event-Schema Standard for AI Observability
...
SPANFORGE defines 18+ built-in namespaces. Each namespace specifies the shape of `payload`:
...
This RFC and the SPANFORGE schema are published under [MIT License](../../LICENSE).
