...
| `since` | `str` | Version in which the type was deprecated (e.g. `"1.0.0"`). |
...
# 'llm.legacy.trace' is deprecated since 1.0.0 and will be removed in 2.0.0.
...
`spanforge.migrate.v2_migration_roadmap()`.
